...
export default function Login(
  ...
  const { i18n, doUseDefaultCss, Template, classes } = props;
  let { kcContext } = props;

  kcContext = {
    ...kcContext,
    login: { username: "pheno" },
    message: {
      type: "info",
      summary:
        "you are about to access the Pheno-Ranker playground the user name is pheno and the password is ranker",
    },
  };
