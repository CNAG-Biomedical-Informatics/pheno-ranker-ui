...
def setup(filename):
    ...
    dwg = svgwrite.Drawing(filename, profile="full", size=(svg_size, svg_size))
...
def inter_cohort_mode_representation(pats_count):
    ...
    clustering_factor = (
        0.3  # Increased clustering factor to allow more space within each quadrant
    )
    ...
    quadrants = [
        {
            "x_center": (svg_size // divisor),
            "y_center": (svg_size // divisor),
            "positions": [],
        },  # Top-left quadrant
        {
            "x_center": (2 * svg_size // divisor),
            "y_center": (svg_size // divisor),
            "positions": [],
        },  # Top-right quadrant
        {
            "x_center": (svg_size // divisor),
            "y_center": (2 * svg_size // divisor),
            "positions": [],
